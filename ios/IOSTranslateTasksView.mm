...
{
    const auto &oldViewProps = *std::static_pointer_cast<IOSTranslateTasksViewProps const>(_props);
    const auto &newViewProps = *std::static_pointer_cast<IOSTranslateTasksViewProps const>(props);
